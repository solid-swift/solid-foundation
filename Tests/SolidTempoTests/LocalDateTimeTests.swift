...
struct LocalDateTimeTests {
  ...
  @Test("LocalDateTime computed components via subscripting")
  func testComputedComponents() throws {
    // March 15, 2024 14:30:45 is a Friday (day 5 in ISO week, where Monday=1)
  ...
  func testComputedComponentsEdgeCases() throws {
    // January 1, 2024 00:00:00 (Monday, first day of year)
    let jan1 = try LocalDateTime(
      year: 2024,
      month: 1,
      day: 1,
      hour: 0,
